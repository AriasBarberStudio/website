        ...
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">Sterling Barbershop</span>
              <img
      ...
      <div className="relative isolate overflow-hidden bg-gray-100 py-24 sm:py-32">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-4xl font-bold tracking-tight text-white sm:text-4xl">About us</h2>
            <p className="mt-6 text-lg leading-8 text-gray-300">
              At Sterling Barbershop, every visit transforms you into your best self. Our dedicated team crafts your unique style, leaving you looking and feeling exceptional. Come experience the extraordinary.
            </p>
          </div>
      ...
      <div className="bg-white py-24 sm:py-32">
        <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
          <div className="max-w-2xl">
            ...
            <h2 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-4xl">Meet our team</h2>
            <p className="mt-6 text-lg leading-8 text-gray-600">
            ...
            {people.map((person) => (
              <li key={person.name}>
                <div className="flex items-center gap-x-10">
                  <img className="rounded" src={person.imageUrl} alt="" width={"75%"} height={"75%"} />
                  <div>
